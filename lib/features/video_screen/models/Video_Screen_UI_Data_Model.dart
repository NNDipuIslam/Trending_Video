...
//
//     final videoScreenUiDataModel = videoScreenUiDataModelFromJson(jsonString);

import 'dart:convert';

List<VideoScreenUiDataModel> videoScreenUiDataModelFromJson(String str) =>
    List<VideoScreenUiDataModel>.from(
        json.decode(str).map((x) => VideoScreenUiDataModel.fromJson(x)));

String videoScreenUiDataModelToJson(List<VideoScreenUiDataModel> data) =>
    json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class VideoScreenUiDataModel {
  String thumbnail;
  int id;
  String title;
  ...
  factory VideoScreenUiDataModel.fromJson(Map<String, dynamic> json) =>
      VideoScreenUiDataModel(
